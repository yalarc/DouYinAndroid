 ...
 */
package com.yalarc.douyin.mvp.model.api.cache;
...
public interface CommonCache {
    ...
    Observable<Reply<Video>> getVideos(Observable<Video> videos, DynamicKey idLastVideoQueried, EvictProvider evictProvider);
}
