...
public class CircularProgressView extends ProgressBar {
    ...
    public CircularProgressView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (isInEditMode()) {
            mColors = new int[4];
            mColors[0] = getResources().getColor(R.color.color_388e3c);
            mColors[1] = getResources().getColor(R.color.color_388e3c);
            mColors[2] = getResources().getColor(R.color.color_388e3c);
            mColors[3] = getResources().getColor(R.color.color_388e3c);
        } else {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        fBounds.right = 75f - mBorderWidth / 2f - .5f;
        fBounds.top = mBorderWidth / 2f + .5f;
        fBounds.bottom = 75f - mBorderWidth / 2f - .5f;
    }
