...
public class MyPagerSnapHelper extends ViewPagerSnapHelper {
    ...
    protected LinearSmoothScroller createSnapScroller(RecyclerView.LayoutManager layoutManager) {
        return !(layoutManager instanceof RecyclerView.SmoothScroller.ScrollVectorProvider) ? null : new LinearSmoothScroller(this.mRecyclerView.getContext()) {
            protected void onTargetFound(View targetView, RecyclerView.State state, Action action) {
                int[] snapDistances = MyPagerSnapHelper.this. calculateDistanceToFinalSnap(MyPagerSnapHelper.this.mRecyclerView.getLayoutManager(), targetView);
