...
public class CircleView extends View {
    ...
    private void updateCircleColor() {
        float colorProgress = (float) DYUtils.clamp(outerCircleRadiusProgress, 0.5, 1);
        colorProgress = (float) DYUtils.mapValueFromRangeToRange(colorProgress, 0.5f, 1f, 0f, 1f);
