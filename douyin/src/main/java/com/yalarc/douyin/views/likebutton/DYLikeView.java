...
public class DYLikeView extends FrameLayout implements View.OnClickListener {
    ...
    public void setLikeDrawableRes(@DrawableRes int resId) {
        ...
        if (iconSize != 0) {
            likeDrawable = DYUtils.resizeDrawable(getContext(), likeDrawable, iconSize, iconSize);
        }
    ...
    public void setLikeDrawable(Drawable likeDrawable) {
        ...
        if (iconSize != 0) {
            this.likeDrawable = DYUtils.resizeDrawable(getContext(), likeDrawable, iconSize, iconSize);
        }
    ...
    public void setUnlikeDrawableRes(@DrawableRes int resId) {
        ...
        if (iconSize != 0) {
            unLikeDrawable = DYUtils.resizeDrawable(getContext(), unLikeDrawable, iconSize, iconSize);
        }
    ...
    public void setUnlikeDrawable(Drawable unLikeDrawable) {
        ...
        if (iconSize != 0) {
            this.unLikeDrawable = DYUtils.resizeDrawable(getContext(), unLikeDrawable, iconSize, iconSize);
        }
    ...
    public void setIconSizeDp(int iconSize) {
        setIconSizePx((int) DYUtils.dipToPixels(getContext(), (float) iconSize));
    }
